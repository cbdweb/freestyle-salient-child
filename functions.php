...
function fs_theme_sign () {
    ...
    <form name="register">
        <table border="0">
            ...
            <tr><td class="leftcol">2+3=</td><td class="rightcol"><td class="rightcol"><input<?=($narrow || $popup) ? " class='smallinput'" : "";?> type="text" name="arithmetic" id="name<?=($popup ? "_popup" : "");?>"></td></tr>

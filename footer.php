...
<div id="call-to-action">
	<div class="container">
		...
		<a href="<?php echo $cta_link ?>"><?php if(!empty($options['cta-btn'])) echo $options['cta-btn']; ?> </a>
                <div class="farleft">Site by <a href="http://www.cbdweb.net">CBDWeb</a>.  See also <a href="http://www.snowaccommodation.info">ski and snow accommodation booking software in Australia</a>.  </div>
	</div>
</div>
		...
		<div class="row" id="copyright">
			...
			<div class="container">
				...
				<div class="col span_5">
					<p>&copy; <?php echo date('Y') . ' Freestyle Cyclists Inc. ' ; ?> <?php if(!empty($options['footer-copyright-text'])) echo $options['footer-copyright-text']; ?> </p>
				</div><!--/span_6-->
